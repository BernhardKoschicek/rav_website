...
!(function (n, t, e) {
  ...
  function P(n, t) {
    return R(n)
      ? new E.LatLngBounds({ lat: n[2], lng: n[3] }, { lat: n[0], lng: n[1] })
      : t && !n.getCenter
      ? new E.LatLngBounds({ lat: n.south, lng: n.west }, { lat: n.north, lng: n.east })
      : n;
  }
  function b(t, o) {
    function r() {
    ...
    return (
      (o = S({ x: 0, y: 0 }, o)),
      o.position ? (o.position = x(o.position, !0)) : o.bounds && (o.bounds = P(o.bounds, !0)),
      (r.prototype = new i()),
      new r()
    );
  }
  ...
  function C(n, t) {
    ...
    function i(n) {
      ...
      return l(
        "LatLngBounds",
        d.fromDivPixelToLatLng(l("Point", t.x - P, t.y + P)),
        d.fromDivPixelToLatLng(l("Point", t.x + P, t.y - P))
      );
    }
    function u() {
  ...
  function k(t, e) {
    ...
    function g(n) {
      return function () {
        ...
        return (P = P.then(function (e) {
          return A(t[0])
            ? O(t[0].call(c(), e)).then(function (e) {
    ...
    (M.map = g(function (n) {
      ...
      (M.directionsrenderer = g(function (t) {
        var e;
        return (
          t && ((t = o(t)), (t.map = v), t.panel && (t.panel = n(t.panel).get(0)), (e = l("DirectionsRenderer", t))),
          y.push(e),
          e
        );
      })),
