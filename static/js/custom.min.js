  ...
  (!(function (t) {
    ...
    t.fn.bxSlider = function (o) {
      ...
      var n = {},
        ...
        a = t(window).height(),
        l = function () {
          (n.settings = t.extend({}, e, o)),
            (n.settings.slideWidth = parseInt(n.settings.slideWidth)),
            (n.children = s.children(n.settings.slideSelector)),
            ...
            (n.carousel = n.settings.minSlides > 1 || n.settings.maxSlides > 1 ? !0 : !1),
            n.carousel && (n.settings.preloadImages = "all"),
            (n.minThreshold =
              n.settings.minSlides * n.settings.slideWidth + (n.settings.minSlides - 1) * n.settings.slideMargin),
            (n.maxThreshold =
              n.settings.maxSlides * n.settings.slideWidth + (n.settings.maxSlides - 1) * n.settings.slideMargin),
            (n.working = !1),
            (n.controls = {}),
            (n.interval = null),
              ...
              (function () {
                ...
                for (var i in e)
                  if (void 0 !== t.style[e[i]])
                    return (
                      (n.cssPrefix = e[i].replace("Perspective", "").toLowerCase()),
                      (n.animProp = "-" + n.cssPrefix + "-transform"),
                      !0
                    );
                return !1;
              })()),
            ...
            s.children(n.settings.slideSelector).each(function () {
              t(this).data("origStyle", t(this).attr("style"));
            }),
            c();
        },
        c = function () {
          s.wrap('<div class="' + n.settings.wrapperClass + '"><div class="bx-viewport"></div></div>'),
            (n.viewport = s.parent()),
            (n.loader = t('<div class="bx-loading" />')),
            n.viewport.prepend(n.loader),
            s.css({
              width: "horizontal" === n.settings.mode ? 1e3 * n.children.length + 215 + "%" : "auto",
              position: "absolute",
            }),
            n.usingCSS && n.settings.easing
              ? s.css("-" + n.cssPrefix + "-transition-timing-function", n.settings.easing)
              : n.settings.easing || (n.settings.easing = "swing"),
            m(),
            n.viewport.css({ width: "100%", overflow: "hidden", position: "relative" }),
            n.viewport.parent().css({ maxWidth: p() }),
            n.settings.pager || n.settings.controls || n.viewport.parent().css({ margin: "0 auto 0px" }),
            n.children.css({
              float: "horizontal" === n.settings.mode ? "left" : "none",
              listStyle: "none",
              position: "relative",
            }),
            n.children.css("width", f()),
            "horizontal" === n.settings.mode &&
              n.settings.slideMargin > 0 &&
              n.children.css("marginRight", n.settings.slideMargin),
            "vertical" === n.settings.mode &&
              n.settings.slideMargin > 0 &&
              n.children.css("marginBottom", n.settings.slideMargin),
            "fade" === n.settings.mode &&
              (n.children.css({ position: "absolute", zIndex: 0, display: "none" }),
              n.children.eq(n.settings.startSlide).css({ zIndex: n.settings.slideZIndex, display: "block" })),
            (n.controls.el = t('<div class="bx-controls" />')),
            n.settings.captions && C(),
            (n.active.last = n.settings.startSlide === g() - 1),
            n.settings.video && s.fitVids();
          var e = n.children.eq(n.settings.startSlide);
          ("all" === n.settings.preloadImages || n.settings.ticker) && (e = n.children),
            n.settings.ticker
              ? (n.settings.pager = !1)
              : (n.settings.controls && S(),
                n.settings.auto && n.settings.autoControls && T(),
                n.settings.pager && x(),
                (n.settings.controls || n.settings.autoControls || n.settings.pager) &&
                  n.viewport.after(n.controls.el)),
            d(e, h);
        },
        d = function (e, i) {
        ...
        h = function () {
          ...
          n.loader.remove(),
            ...
            n.viewport.height(u()),
            s.redrawSlider(),
            n.settings.onSliderLoad(n, n.active.index),
            (n.initialized = !0),
            n.settings.responsive && t(window).bind("resize", q),
            n.settings.auto && n.settings.autoStart && (g() > 1 || n.settings.autoSlideForOnePage) && O(),
            n.settings.ticker && L(),
            n.settings.pager && M(n.settings.startSlide),
            n.settings.controls && A(),
            n.settings.touchEnabled && !n.settings.ticker && H(),
            n.settings.keyboardEnabled && !n.settings.ticker && t(document).keydown(R);
        },
        u = function () {
          var e = 0,
            o = t();
          ...
          return (
            ...
            "border-box" === n.viewport.css("box-sizing")
              ? (e +=
                  parseFloat(n.viewport.css("padding-top")) +
                  parseFloat(n.viewport.css("padding-bottom")) +
                  parseFloat(n.viewport.css("border-top-width")) +
                  parseFloat(n.viewport.css("border-bottom-width")))
              : "padding-box" === n.viewport.css("box-sizing") &&
                (e += parseFloat(n.viewport.css("padding-top")) + parseFloat(n.viewport.css("padding-bottom"))),
            e
          );
        },
        p = function () {
          var t = "100%";
          return (
            n.settings.slideWidth > 0 &&
              (t =
                "horizontal" === n.settings.mode
                  ? n.settings.maxSlides * n.settings.slideWidth + (n.settings.maxSlides - 1) * n.settings.slideMargin
                  : n.settings.slideWidth),
            t
          );
        },
        f = function () {
          var t = n.settings.slideWidth,
            e = n.viewport.width();
          return (
            0 === n.settings.slideWidth || (n.settings.slideWidth > e && !n.carousel) || "vertical" === n.settings.mode
              ? (t = e)
              : n.settings.maxSlides > 1 &&
                "horizontal" === n.settings.mode &&
                (e > n.maxThreshold ||
                  (e < n.minThreshold &&
        ...
        w = function () {
          ...
          if (n.children.length > n.settings.maxSlides && n.active.last && !n.settings.infiniteLoop) {
            ...
            (t = n.children.eq(n.active.index * v()).position()),
              n.active.index === g() - 1 && (n.active.last = !0),
              void 0 !== t &&
                ("horizontal" === n.settings.mode
                  ? y(-t.left, "reset", 0)
                  : "vertical" === n.settings.mode && y(-t.top, "reset", 0));
        },
        y = function (t, e, i, o) {
          if (n.usingCSS) {
            var r =
              "vertical" === n.settings.mode ? "translate3d(0, " + t + "px, 0)" : "translate3d(" + t + "px, 0, 0)";
            s.css("-" + n.cssPrefix + "-transition-duration", i / 1e3 + "s"),
              "slide" === e
                ? setTimeout(function () {
                    s.css(n.animProp, r),
                      0 === t
                ...
                ? s.css(n.animProp, r)
                : "ticker" === e &&
                  (s.css("-" + n.cssPrefix + "-transition-timing-function", "linear"),
                  s.css(n.animProp, r),
                  s.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function () {
                    s.unbind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd"),
                      y(o.resetValue, "reset", 0),
                      N();
                  }));
          } else {
            var a = {};
            (a[n.animProp] = t),
              "slide" === e
                ? s.animate(a, i, n.settings.easing, function () {
                    $();
                  })
                : "reset" === e
                ? s.css(n.animProp, t)
        ...
        b = function () {
          for (var e = "", i = g(), o = 0; i > o; o++) {
            var s = "";
            (n.settings.buildPager && t.isFunction(n.settings.buildPager)) || n.settings.pagerCustom
              ? ((s = n.settings.buildPager(o)), n.pagerEl.addClass("bx-custom-pager"))
              : ((s = o + 1), n.pagerEl.addClass("bx-default-pager")),
              (e +=
        ...
        x = function () {
          n.settings.pagerCustom
            ? (n.pagerEl = t(n.settings.pagerCustom))
            : ((n.pagerEl = t('<div class="bx-pager" />')),
              n.settings.pagerSelector
                ? t(n.settings.pagerSelector).html(n.pagerEl)
                : n.controls.el.addClass("bx-has-pager").append(n.pagerEl),
              b()),
            n.pagerEl.on("click touchend", "a", _);
        },
        S = function () {
          (n.controls.next = t('<a class="bx-next" href="">' + n.settings.nextText + "</a>")),
            (n.controls.prev = t('<a class="bx-prev" href="">' + n.settings.prevText + "</a>")),
            n.controls.next.bind("click touchend", k),
            n.controls.prev.bind("click touchend", E),
            ...
            n.settings.nextSelector ||
              ...
              ((n.controls.directionEl = t('<div class="bx-controls-direction" />')),
              n.controls.directionEl.append(n.controls.prev).append(n.controls.next),
              n.controls.el.addClass("bx-has-controls-direction").append(n.controls.directionEl));
        },
        T = function () {
          (n.controls.start = t(
            '<div class="bx-controls-auto-item"><a class="bx-start" href="">' + n.settings.startText + "</a></div>"
          )),
            (n.controls.stop = t(
              '<div class="bx-controls-auto-item"><a class="bx-stop" href="">' + n.settings.stopText + "</a></div>"
            )),
            (n.controls.autoEl = t('<div class="bx-controls-auto" />')),
            n.controls.autoEl.on("click", ".bx-start", z),
            n.controls.autoEl.on("click", ".bx-stop", I),
            n.settings.autoControlsCombine
              ? n.controls.autoEl.append(n.controls.start)
              : n.controls.autoEl.append(n.controls.start).append(n.controls.stop),
            n.settings.autoControlsSelector
              ? t(n.settings.autoControlsSelector).html(n.controls.autoEl)
              : n.controls.el.addClass("bx-has-controls-auto").append(n.controls.autoEl),
            P(n.settings.autoStart ? "stop" : "start");
        },
        C = function () {
        ...
        k = function (t) {
          t.preventDefault(),
            n.controls.el.hasClass("disabled") || (n.settings.auto && s.stopAuto(), s.goToNextSlide());
        },
        E = function (t) {
          t.preventDefault(),
            n.controls.el.hasClass("disabled") || (n.settings.auto && s.stopAuto(), s.goToPrevSlide());
        },
        z = function (t) {
        ...
        M = function (e) {
          ...
          return "short" === n.settings.pagerType
            ? (n.settings.maxSlides > 1 && (i = Math.ceil(n.children.length / n.settings.maxSlides)),
              void n.pagerEl.html(e + 1 + n.settings.pagerShortSeparator + i))
        ...
        $ = function () {
          if (n.settings.infiniteLoop) {
            var t = "";
            0 === n.active.index
              ? (t = n.children.eq(0).position())
              : n.active.index === g() - 1 && n.carousel
              ? (t = n.children.eq((g() - 1) * v()).position())
        ...
        P = function (t) {
          n.settings.autoControlsCombine
            ? n.controls.autoEl.html(n.controls[t])
            : (n.controls.autoEl.find("a").removeClass("active"),
              n.controls.autoEl.find("a:not(.bx-" + t + ")").addClass("active"));
        },
        A = function () {
          1 === g()
        ...
        O = function () {
          n.settings.autoDelay > 0
            ? setTimeout(s.startAuto, n.settings.autoDelay)
            : (s.startAuto(),
              t(window)
                .focus(function () {
                  s.startAuto();
        ...
        L = function () {
          ...
          if (
            ...
            if (n.usingCSS) {
              var o,
                r = "horizontal" == n.settings.mode ? 4 : 5;
              n.viewport.hover(
                function () {
        ...
        N = function (t) {
          ...
          var e = { left: 0, top: 0 },
            i = { left: 0, top: 0 };
          "next" === n.settings.autoDirection
            ? (e = s.find(".bx-clone").first().position())
            : (i = n.children.first().position());
        ...
        D = function (e) {
          ...
          return (
            ...
            !(o.right < n.left || o.left > n.right || o.bottom < n.top || o.top > n.bottom)
          );
        },
        R = function (t) {
        ...
        H = function () {
          (n.touch = { start: { x: 0, y: 0 }, end: { x: 0, y: 0 } }),
            n.viewport.bind("touchstart MSPointerDown pointerdown", B),
        ...
        B = function (t) {
          if ((n.controls.el.addClass("disabled"), n.working))
            ...
            (n.touch.start.x = i[0].pageX),
              (n.touch.start.y = i[0].pageY),
              n.viewport.get(0).setPointerCapture &&
                ((n.pointerId = e.pointerId), n.viewport.get(0).setPointerCapture(n.pointerId)),
              n.viewport.bind("touchmove MSPointerMove pointermove", W),
              n.viewport.bind("touchend MSPointerUp pointerup", F),
              n.viewport.bind("MSPointerCancel pointercancel", j);
          }
        },
        j = function () {
          y(n.touch.originalPos.left, "reset", 0),
            n.controls.el.removeClass("disabled"),
            n.viewport.unbind("MSPointerCancel pointercancel", j),
            n.viewport.unbind("touchmove MSPointerMove pointermove", W),
            n.viewport.unbind("touchend MSPointerUp pointerup", F),
        ...
        W = function (t) {
          ...
          if (
            (3 * o > s && n.settings.preventDefaultSwipeX
              ? t.preventDefault()
              : 3 * s > o && n.settings.preventDefaultSwipeY && t.preventDefault(),
            "fade" !== n.settings.mode && n.settings.oneToOneTouch)
          ) {
            var r = 0,
              a = 0;
            "horizontal" === n.settings.mode
              ? ((a = i[0].pageX - n.touch.start.x), (r = n.touch.originalPos.left + a))
              : ((a = i[0].pageY - n.touch.start.y), (r = n.touch.originalPos.top + a)),
              y(r, "reset", 0);
          }
        },
        F = function (t) {
          ...
          (n.touch.end.x = i[0].pageX),
            ...
            "fade" === n.settings.mode
              ? ((r = Math.abs(n.touch.start.x - n.touch.end.x)),
                r >= n.settings.swipeThreshold &&
                  (n.touch.start.x > n.touch.end.x ? s.goToNextSlide() : s.goToPrevSlide(), s.stopAuto()))
              : ("horizontal" === n.settings.mode
                  ? ((r = n.touch.end.x - n.touch.start.x), (o = n.touch.originalPos.left))
                  : ((r = n.touch.end.y - n.touch.start.y), (o = n.touch.originalPos.top)),
                !n.settings.infiniteLoop && ((0 === n.active.index && r > 0) || (n.active.last && 0 > r))
                  ? y(o, "reset", 200)
                  : Math.abs(r) >= n.settings.swipeThreshold
                  ? (0 > r ? s.goToNextSlide() : s.goToPrevSlide(), s.stopAuto())
                  : y(o, "reset", 200)),
            n.viewport.unbind("touchend MSPointerUp pointerup", F),
            n.viewport.get(0).releasePointerCapture && n.viewport.get(0).releasePointerCapture(n.pointerId);
        },
          ...
          if (n.initialized)
            if (n.working) window.setTimeout(q, 10);
              ...
              var e = t(window).width(),
                i = t(window).height();
              (r !== e || a !== i) &&
                ((r = e), (a = i), s.redrawSlider(), n.settings.onSliderResize.call(s, n.active.index));
            }
        };
      return (
        (s.goToSlide = function (e, i) {
          if (!n.working && n.active.index !== e) {
            ...
            var o = !0;
            if (
              ((o = n.settings.onSlideBefore(n.children.eq(n.active.index), n.oldIndex, n.active.index)),
              "undefined" != typeof o && !o)
            )
              return (n.active.index = n.oldIndex), void (n.working = !1);
            if (
              ("next" === i
                ? n.settings.onSlideNext(n.children.eq(n.active.index), n.oldIndex, n.active.index) || (o = !1)
                : "prev" === i &&
                  (n.settings.onSlidePrev(n.children.eq(n.active.index), n.oldIndex, n.active.index) || (o = !1)),
              "undefined" != typeof o && !o)
            )
              return (n.active.index = n.oldIndex), void (n.working = !1);
            if (
              ((n.active.last = n.active.index >= g() - 1),
              (n.settings.pager || n.settings.pagerCustom) && M(n.active.index),
              n.settings.controls && A(),
              "fade" === n.settings.mode)
            )
              n.settings.adaptiveHeight &&
                n.viewport.height() !== u() &&
                n.viewport.animate({ height: u() }, n.settings.adaptiveHeightSpeed),
              ...
              if (!n.settings.infiniteLoop && n.carousel && n.active.last)
                if ("horizontal" === n.settings.mode)
                  (l = n.children.eq(n.children.length - 1)),
                    (a = l.position()),
                    (r = n.viewport.width() - l.outerWidth());
                else {
                ...
                var d =
                  1 === n.settings.moveSlides
                    ? n.settings.maxSlides - v()
                    : (g() - 1) * v() - (n.children.length - n.settings.maxSlides);
        ...
        (s.startAuto = function (t) {
          n.interval ||
            ...
            n.settings.autoControls && t !== !0 && P("stop"));
        }),
        (s.stopAuto = function (t) {
          n.interval &&
            (clearInterval(n.interval), (n.interval = null), n.settings.autoControls && t !== !0 && P("start"));
        }),
        ...
        (s.redrawSlider = function () {
          n.children.add(s.find(".bx-clone")).outerWidth(f()),
            n.viewport.css("height", u()),
            n.settings.ticker || w(),
            n.active.last && (n.active.index = g() - 1),
            n.active.index >= g() && (n.active.last = !0),
            n.settings.pager && !n.settings.pagerCustom && (b(), M(n.active.index));
        }),
        (s.destroySlider = function () {
          n.initialized &&
            ...
            n.settings.keyboardEnabled && t(document).unbind("keydown", R));
        }),
  ...
  !(function (t, e, i, o) {
    ...
    var s = "stellar",
      ...
      c = (function () {
        ...
        return (
          "WebkitOpacity" in o && (n = "Webkit"),
          "KhtmlOpacity" in o && (n = "Khtml"),
          function (t) {
      ...
      d = c("transform"),
      h = t("<div />", { style: "background:#fff" }).css("background-position-x") !== o,
      u = h
        ? function (t, e, i) {
    ...
    (n.prototype = {
      ...
      _defineElements: function () {
        this.element === i.body && (this.element = e),
          ...
          (this.$viewportElement =
            this.options.viewportElement !== o
              ...
              e.options.showElement(u),
                ...
                u.parents().each(function () {
                  ...
                  return e.data("stellar-offset-parent") === !0
                    ? ((p = m), (f = g), (c = e), !1)
                    : ((m += e.position().left), void (g += e.position().top));
                }),
                (i =
                  u.data("stellar-horizontal-offset") !== o
                    ? u.data("stellar-horizontal-offset")
                    : c !== o && c.data("stellar-horizontal-offset") !== o
                    ? c.data("stellar-horizontal-offset")
                    : e.horizontalOffset),
                (n =
                  u.data("stellar-vertical-offset") !== o
                    ? u.data("stellar-vertical-offset")
                    : c !== o && c.data("stellar-vertical-offset") !== o
          ...
          this.options.parallaxBackgrounds &&
            ...
            e.each(function () {
              ...
              f.data("stellar-backgroundStartingLeft")
                ? u(f, f.data("stellar-backgroundStartingLeft"), f.data("stellar-backgroundStartingTop"))
                : (f.data("stellar-backgroundStartingLeft", m[0]), f.data("stellar-backgroundStartingTop", m[1])),
                ...
                f.parents().each(function () {
                  ...
                  return e.data("stellar-offset-parent") === !0
                    ? ((g = w), (v = y), (h = e), !1)
                    : ((w += e.position().left), void (y += e.position().top));
                }),
                (e =
                  f.data("stellar-horizontal-offset") !== o
                    ? f.data("stellar-horizontal-offset")
                    : h !== o && h.data("stellar-horizontal-offset") !== o
                    ? h.data("stellar-horizontal-offset")
                    : i.horizontalOffset),
                (r =
                  f.data("stellar-vertical-offset") !== o
                    ? f.data("stellar-vertical-offset")
                    : h !== o && h.data("stellar-vertical-offset") !== o
          ...
          for (
            ...
            (t = this.particles[c]),
              ...
              this.options.horizontalScrolling
                ? ((s =
                    (d +
                      ...
                      -(t.stellarRatio + e - 1) +
                    t.startingPositionLeft),
                  (a = s - t.startingPositionLeft + t.startingOffsetLeft))
                : ((s = t.startingPositionLeft), (a = t.startingOffsetLeft)),
              ...
              this.options.hideDistantElements &&
                ((f =
                  !this.options.horizontalScrolling ||
                  (a + t.width > (t.isFixed ? 0 : d) &&
                    a < (t.isFixed ? 0 : d) + this.viewportWidth + this.viewportOffsetLeft)),
                (p =
                  !this.options.verticalScrolling ||
                  (l + t.height > (t.isFixed ? 0 : h) &&
                    l < (t.isFixed ? 0 : h) + this.viewportHeight + this.viewportOffsetTop))),
              f && p
                ? (t.isHidden && (this.options.showElement(t.$element), (t.isHidden = !1)),
                  this._setPosition(t.$element, s, t.startingPositionLeft, r, t.startingPositionTop))
                : t.isHidden || (this.options.hideElement(t.$element), (t.isHidden = !0));
          for (c = this.backgrounds.length - 1; c >= 0; c--)
            (i = this.backgrounds[c]),
              (e = i.isFixed ? 0 : 1),
      ...
      (t[s].scrollProperty = a),
      (t[s].positionProperty = l),
      (e.Stellar = n);
      ...
      return this.each(function () {
        var e = t(this),
          ...
          n = function () {
            ...
            n = n.replace(/,/g, "");
            for (
              var r = (/^[0-9]+$/.test(n), /^[0-9]+\.[0-9]+$/.test(n)),
                a = r ? (n.split(".")[1] || []).length : 0,
                l = i;
              l >= 1;
              l--
            ) {
...
if (
        ...
        e && e.preventDefault(),
          ...
          e.isDefaultPrevented() ||
            ...
            t.support.transition && r.hasClass("fade")
              ? r.one("bsTransitionEnd", i).emulateTransitionEnd(o.TRANSITION_DURATION)
              : i());
      });
    var n = t.fn.alert;
    (t.fn.alert = e),
      ...
      (e && 3 === e.which) ||
        ...
        t(s).each(function () {
          ...
          n.hasClass("open") &&
            ...
            e.isDefaultPrevented() ||
              (o.attr("aria-expanded", "false"), n.removeClass("open").trigger("hidden.bs.dropdown", s)));
        }));
    }
    function i(e) {
      ...
      (i.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (c) {
            ...
            (a =
              "bottom" == a && d.bottom + u > m.bottom
                ? "top"
                : "top" == a && d.top - u < m.top
                ? "bottom"
                : "right" == a && d.right + h > m.width
                ? "left"
                : "left" == a && d.left - h < m.left
                ? "right"
                : a),
    ...
    (i.VERSION = "3.3.4"),
      ...
      (i.prototype.show = function () {
        var e = this.element,
          ...
          o = e.data("target");
        if (
          (o || ((o = e.attr("href")), (o = o && o.replace(/.*(?=#[^\s]*$)/, ""))), !e.parent("li").hasClass("active"))
        ) {
  ...
  (function () {
    $(".footer-bottom").parent().is(".copy-right.pull-right")
      ? alert(
          "You Cannot remove Copyrights. Please Contact us  " +
            window.location.assign("http://jeweltheme.com/product/polmo")
        )
      : $(".copy-right").append(
          '© <a href="http://demos.jeweltheme.com/polmo" target="_blank">Polmo</a> 2015 - All Reserves. Developed by <a href="http://jeweltheme.com/" target="_blank">Jewel Theme</a>. Designed by <a href="https://www.facebook.com/dinmuhammadsumon" target="_blank">D.M.S</a>'
        );
  })(jQuery),
  (function (t) {
          ...
          function e(e) {
            if ((i.preventDefaultEvents && e.preventDefault(), r)) {
              var o = e.touches[0].pageX,
                ...
                l = n - o,
                c = s - a;
              Math.abs(l) >= i.min_move_x
                ? (t(), l > 0 ? i.wipeLeft() : i.wipeRight())
                : Math.abs(c) >= i.min_move_y && (t(), c > 0 ? i.wipeDown() : i.wipeUp());
            }
          }
          function o(t) {
            1 == t.touches.length &&
              ((n = t.touches[0].pageX), (s = t.touches[0].pageY), (r = !0), this.addEventListener("touchmove", e, !1));
          }
          var n,
            s,
            r = !1;
    ...
    var e,
      ...
      T = function (e, i, o, n) {
        ...
        return (
          (s.className = "mfp-" + e),
          o && (s.innerHTML = o),
          n ? i && i.appendChild(s) : ((s = t(s)), i && s.appendTo(i)),
          s
        );
      },
      C = function (i, o) {
      ...
      k = function (i) {
        return (
          (i === r && e.currTemplate.closeBtn) ||
            ((e.currTemplate.closeBtn = t(e.st.closeMarkup.replace("%title%", e.st.tClose))), (r = i)),
    ...
    (y.prototype = {
      ...
      open: function (i) {
        ...
        C("BeforeOpen"),
          ...
          (e.st.fixedBgPos === !1 || ("auto" === e.st.fixedBgPos && !e.fixedContentPos)) &&
      ...
      appendContent: function (t, i) {
        (e.content = t),
          t
            ? e.st.showCloseBtn && e.st.closeBtnInside && e.currTemplate[i] === !0
      ...
      addGroup: function (t, i) {
        ...
        (i.mainEl = t),
          i.items
            ...
            : ((i.isObj = !1), i.delegate ? t.off(n).on(n, i.delegate, o) : ((i.items = t), t.off(n).on(n, o)));
      },
            ...
            if (((n = t.split("_")), n.length > 1)) {
              ...
              if (o.length > 0) {
                ...
                "replaceWith" === s
                  ...
                  ? o.is("img")
                    ? o.attr("src", i)
                    : o.replaceWith('<img src="' + i + '" class="' + o.attr("class") + '" />')
                  : o.attr(n[1], i);
              }
      ...
      (t.fn.magnificPopup = function (i) {
        ...
        if ("string" == typeof i)
          if ("open" === i) {
            var n,
              s = b ? o.data("magnificPopup") : o[0].magnificPopup,
              r = parseInt(arguments[1], 10) || 0;
            s.items ? (n = s.items[r]) : ((n = o), s.delegate && (n = n.find(s.delegate)), (n = n.eq(r))),
              e._openClick({ mfpEl: n }, o, s);
        ...
        getInline: function (i, o) {
          if ((P(), i.src)) {
            ...
            if (s.length) {
              ...
              r &&
                r.tagName &&
                (_ || ((I = n.hiddenClass), (_ = T(I)), (I = "mfp-" + I)), (M = s.after(_).detach().removeClass(I))),
    ...
    t.magnificPopup.registerModule("image", {
      ...
      proto: {
        ...
        getImage: function (i, o) {
          ...
          return (
            e._parseMarkup(o, { title: R(i), img_replaceWith: i.img }, i),
            e.resizeImage(),
            i.hasSize
              ? (D && clearInterval(D),
                i.loadError
                  ? (o.addClass("mfp-loading"), e.updateStatus("error", a.tError.replace("%url%", i.src)))
                  : (o.removeClass("mfp-loading"), e.updateStatus("ready")),
                o)
              : (e.updateStatus("loading"),
                (i.loading = !0),
                i.hasSize || ((i.imgHidden = !0), o.addClass("mfp-loading"), e.findImageSize(i)),
                o)
          );
        },
      },
                ...
                S("BuildControls" + n, function () {
                  if (e.items.length > 1 && i.arrows && !e.arrowLeft) {
                    ...
                    n[a](function () {
                      ...
                      e.isIE7 &&
                        (T("b", n[0], !1, !0), T("a", n[0], !1, !0), T("b", s[0], !1, !0), T("a", s[0], !1, !0)),
          ...
          return t(this).each(function () {
            ...
            if (i) {
              ...
              a.on("touchstart" + s, function (t) {
                (h = !1),
                  (p = 1),
                  (u = t.originalEvent ? t.originalEvent.touches[0] : t.touches[0]),
                  (c = u.clientX),
                  (d = u.clientY),
                  x
                    .on("touchmove" + s, function (t) {
                      (u = t.originalEvent ? t.originalEvent.touches : t.touches),
                        (p = u.length),
                        (u = u[0]),
                        (Math.abs(u.clientX - c) > 10 || Math.abs(u.clientY - d) > 10) && ((h = !0), o());
                    })
        ...
        function e() {
          i.el.complete
            ? (s.force_original_dimensions &&
                (i.el.setAttribute("width", i.el.offsetWidth), i.el.setAttribute("height", i.el.offsetHeight)),
  ...
  eval(function (t, e) {
    ...
    var i,
      ...
      a = function (t) {
        ...
        t = s(t);
        for (var n = 0, a = r.length; a > n; n++) if (((e = r[n] + t), "string" == typeof i[e])) return e;
      },
      l = a("transform"),
    ...
    if (n) for (i in d) n.hasOwnProperty(i) || n.addTest(i, d[i]);
    else {
      n = t.Modernizr = { _version: "1.6ish: miniModernizr for Isotope" };
      var h,
        u = " ";
    ...
    (e.Isotope.settings = {
      ...
      (e.Isotope.prototype = {
        _create: function (t) {
          ...
          setTimeout(function () {
            ...
            this.options.resizable &&
              x.bind("smartresize.isotope", function () {
                l.resize();
              }),
        ...
        _updateUsingTransforms: function () {
          var t = (this.usingTransforms =
            this.options.transformsEnabled && n.csstransforms && n.csstransitions && !this.isUsingJQueryAnimation);
          ...
          var t = this.options.sortBy,
            ...
            o = function (o, n) {
              var s = e(o, t),
                r = e(n, t);
              return (
                s === r && "original-order" !== t && ((s = e(o, "original-order")), (r = e(n, "original-order"))),
                (s > r ? 1 : r > s ? -1 : 0) * i
              );
            };
        ...
        _pushPosition: function (t, e, i) {
          ...
          this.styleQueue.push({ $el: t, style: o }),
            this.options.itemPositionDataEnabled && t.data("isotope-item-position", { x: e, y: i });
        },
        layout: function (t, e) {
        ...
        _processStyleQueue: function (t, i) {
          ...
          if (
            ...
            if (
              ...
              (a = function () {
                if (!h) {
                  for (var e, i = 0, o = u.length; o > i; i++)
                    (e = u[i]), "function" == typeof e && e.call(p.element, t, p);
                  h = !0;
                }
              }),
        ...
        _revealAppended: function (t, e) {
          ...
          setTimeout(function () {
            t.removeClass("no-transition"),
              i.styleQueue.push({ $el: t, style: i.options.visibleStyle }),
              (i._isInserting = !1),
        ...
        remove: function (t, e) {
          ...
          t.filter(":not(." + this.options.hiddenClass + ")").length
            ? (this.styleQueue.push({ $el: t, style: this.options.hiddenStyle }), this._sort(), this.reLayout(o))
            : o();
        },
        shuffle: function (t) {
        ...
        _fitRowsLayout: function (t) {
          ...
          t.each(function () {
            var t = e(this),
              s = t.outerWidth(!0),
              r = t.outerHeight(!0);
            0 !== n.x && s + n.x > o && ((n.x = 0), (n.y = n.height)),
              i._pushPosition(t, n.x, n.y),
        ...
        _cellsByRowGetContainerSize: function () {
          return {
            height:
              Math.ceil(this.$filteredAtoms.length / this.cellsByRow.cols) * this.cellsByRow.rowHeight +
              this.offset.top,
          };
        },
        ...
        _fitColumnsLayout: function (t) {
          ...
          t.each(function () {
            var t = e(this),
              s = t.outerWidth(!0),
              r = t.outerHeight(!0);
            0 !== n.y && r + n.y > o && ((n.x = n.width), (n.y = 0)),
              i._pushPosition(t, n.x, n.y),
              (n.width = Math.max(n.x + s, n.width)),
              (n.y += r);
          });
        },
      ...
      (e.fn.imagesLoaded = function (t) {
        ...
        function o(t) {
          ...
          n.src !== a &&
            -1 === e.inArray(n, l) &&
            (l.push(n), --r <= 0 && (setTimeout(i), s.unbind(".imagesLoaded", o)));
        }
        var n = this,
        ...
        this.each(function () {
          ...
          return i
            ? e.isFunction(i[t]) && "_" !== t.charAt(0)
              ? void i[t].apply(i, o)
              : void S("no such method '" + t + "' for isotope instance")
            : void S("cannot call methods on isotope prior to initialization; attempted to call method '" + t + "'");
        });
      } else
        this.each(function () {
  ...
  jQuery.extend(jQuery.easing, {
    ...
    easeInOutElastic: function (t, e, i, o, n) {
      ...
      if ((r || (r = 0.3 * n * 1.5), a < Math.abs(o))) {
        a = o;
        var s = r / 4;
      } else var s = (r / (2 * Math.PI)) * Math.asin(o / a);
      return 1 > e
        ? -0.5 * a * Math.pow(2, 10 * (e -= 1)) * Math.sin((2 * (e * n - s) * Math.PI) / r) + i
        : a * Math.pow(2, -10 * (e -= 1)) * Math.sin((2 * (e * n - s) * Math.PI) / r) * 0.5 + o + i;
    },
    ...
    easeInOutBack: function (t, e, i, o, n, s) {
      return (
        void 0 == s && (s = 1.70158),
        (e /= n / 2) < 1
          ? (o / 2) * e * e * (((s *= 1.525) + 1) * e - s) + i
          : (o / 2) * ((e -= 2) * e * (((s *= 1.525) + 1) * e + s) + 2) + i
      );
    },
    ...
    easeInOutBounce: function (t, e, i, o, n) {
      return n / 2 > e
        ? 0.5 * jQuery.easing.easeInBounce(t, 2 * e, 0, o, n) + i
        : 0.5 * jQuery.easing.easeOutBounce(t, 2 * e - n, 0, o, n) + 0.5 * o + i;
    },
  }),
  (function (t) {
    "use strict";
  ...
  (function (t) {
    ...
    if (!a)
      for (var c in r) {
        var d = r[c];
        a || (a = window[d + "RequestAnimationFrame"]),
    ...
    var h = window.MutationObserver || window.WebKitMutationObserver || !1,
      ...
      f = function () {
        ...
        (e.isopera = "opera" in window),
          ...
          (e.transitionend = !1);
        for (
          var i = ["transform", "msTransform", "webkitTransform", "MozTransform", "OTransform"], o = 0;
          o < i.length;
          o++
        )
        ...
        (e.hastransform = 0 != e.trstyle),
          e.hastransform &&
            ((t.style[e.trstyle] = "translate3d(1px,2px,3px)"),
        ...
        t: {
          for (
            i = ["-moz-grab", "-webkit-grab", "grab"], ((e.ischrome && !e.ischrome22) || e.isie) && (i = []), o = 0;
            o < i.length;
            o++
          )
        ...
        return (
          (e.cursorgrabvalue = i), (e.hasmousecapture = "setCapture" in t), (e.hasMutationObserver = !1 !== h), (p = e)
        );
      },
      m = function (r, c) {
        function d() {
            ...
            isNaN(t)
              ? ((t = T[e] || 0),
                (i =
                  3 == t
                    ? i
                      ? w.win.outerHeight() - w.win.innerHeight()
        ...
        function m(t, e, i, o) {
          w._bind(
            ...
            function (o) {
              ...
              return (
                "mousewheel" == e
                  ? ((n.deltaY = -0.025 * o.wheelDelta), o.wheelDeltaX && (n.deltaX = -0.025 * o.wheelDeltaX))
                  : (n.deltaY = o.detail),
                i.call(t, n)
              );
            },
        ...
        function v(t, e, i) {
          ...
          if (
            (0 == t.deltaMode
              ? ((o = -Math.floor(t.deltaX * (w.opt.mousescrollstep / 54))),
                (n = -Math.floor(t.deltaY * (w.opt.mousescrollstep / 54))))
              : 1 == t.deltaMode &&
                ((o = -Math.floor(t.deltaX * w.opt.mousescrollstep)),
                (n = -Math.floor(t.deltaY * w.opt.mousescrollstep))),
            e && w.opt.oneaxismousemode && 0 == o && n && ((o = n), (n = 0)),
            o &&
        ...
        (this.iddoc = (this.doc = w.opt.doc) && this.doc[0] ? this.doc[0].id || "" : ""),
          ...
          (this.win = w.opt.win || (this.ispage ? t(window) : this.doc)),
        ...
        (this.ishwscroll = (this.canhwscroll = b.hastransform && w.opt.hwacceleration) && w.haswrapper),
          ...
          w.opt.enablemouselockapi || ((b.hasmousecapture = !1), (b.haspointerlock = !1)),
        ...
        if (
          ...
          (this.getScrollTop = function (t) {
            ...
            (this.notifyScrollEvent = document.createEvent
              ...
              : function () {}),
            b.hastranslate3d && w.opt.enabletranslate3d
              ? ((this.setScrollTop = function (t, e) {
                  (w.doc.translate.y = t),
                    (w.doc.translate.ty = -1 * t + "px"),
                    w.doc.css(b.trstyle, "translate3d(" + w.doc.translate.tx + "," + w.doc.translate.ty + ",0px)"),
                    e || w.notifyScrollEvent(w.win[0]);
                }),
                (this.setScrollLeft = function (t, e) {
                  (w.doc.translate.x = t),
                    (w.doc.translate.tx = -1 * t + "px"),
                    w.doc.css(b.trstyle, "translate3d(" + w.doc.translate.tx + "," + w.doc.translate.ty + ",0px)"),
                    e || w.notifyScrollEvent(w.win[0]);
                }))
              : ((this.setScrollTop = function (t, e) {
                  (w.doc.translate.y = t),
                    (w.doc.translate.ty = -1 * t + "px"),
                    w.doc.css(b.trstyle, "translate(" + w.doc.translate.tx + "," + w.doc.translate.ty + ")"),
                    e || w.notifyScrollEvent(w.win[0]);
                }),
                (this.setScrollLeft = function (t, e) {
                  (w.doc.translate.x = t),
        ...
        (this.getOffset = function () {
          ...
          var t = w.win.offset(),
            e = w.viewport.offset();
          return { top: t.top - e.top + w.viewport.scrollTop(), left: t.left - e.left + w.viewport.scrollLeft() };
        }),
          (this.updateScrollBar = function (t) {
            if (w.ishwscroll)
              w.rail.css({ height: w.win.innerHeight() }), w.railh && w.railh.css({ width: w.win.innerWidth() });
            else {
              var e = w.getOffset(),
                i = e.top,
                o = e.left,
              ...
              var o =
                  o +
                  (w.rail.align
                    ? w.win.outerWidth() - p(w.win, "border-right-width") - w.rail.width
                    : p(w.win, "border-left-width")),
                n = w.opt.railoffset;
              n && (n.top && (i += n.top), w.rail.align && n.left && (o += n.left)),
                w.locked || w.rail.css({ top: i, left: o, height: t ? t.h : w.win.innerHeight() }),
                w.zoom && w.zoom.css({ top: i + 1, left: 1 == w.rail.align ? o - 20 : o + w.rail.width + 4 }),
                w.railh &&
                  !w.locked &&
                  ((i = e.top),
                  (o = e.left),
                  (t = w.railh.align
                    ? i + p(w.win, "border-top-width", !0) + w.win.innerHeight() - w.railh.height
                    : i + p(w.win, "border-top-width", !0)),
                  (o += p(w.win, "border-left-width")),
                  w.railh.css({ top: t, left: o, width: w.railh.width }));
            }
          }),
          (this.doRailClick = function (t, e, i) {
            ...
            w.locked ||
              (w.cancelEvent(t),
              e
                ? ((e = i ? w.doScrollLeft : w.doScrollTop),
                  (o = i
                    ? (t.pageX - w.railh.offset().left - w.cursorwidth / 2) * w.scrollratio.x
                    : (t.pageY - w.rail.offset().top - w.cursorheight / 2) * w.scrollratio.y),
                  e(o))
                : ((e = i ? w.doScrollLeftBy : w.doScrollBy),
                  (o = i ? w.scroll.x : w.scroll.y),
                  (t = i ? t.pageX - w.railh.offset().left : t.pageY - w.rail.offset().top),
                  (i = i ? w.view.w : w.view.h),
                  e(o >= t ? i : -i)));
          }),
          (w.hasanimationframe = a),
          (w.hascancelanimationframe = l),
          w.hasanimationframe
            ? w.hascancelanimationframe ||
              (l = function () {
          ...
          (this.init = function () {
            ...
            if (
              (b.hasmstouch && w.css(w.ispage ? t("html") : w.win, { "-ms-touch-action": "none" }),
              (w.zindex = "auto"),
              (w.zindex = w.ispage || "auto" != w.opt.zindex ? w.opt.zindex : d() || "auto"),
              !w.ispage && "auto" != w.zindex && w.zindex > s && (s = w.zindex),
              w.isie && 0 == w.zindex && "auto" == w.opt.zindex && (w.zindex = "auto"),
              !w.ispage || (!b.cantouch && !b.isieold && !b.isie9mobile))
            ) {
              var n = w.docscroll;
              w.ispage && (n = w.haswrapper ? w.win : w.doc),
                b.isie9mobile || w.css(n, { "overflow-y": "hidden" }),
                w.ispage &&
                  b.isie7 &&
                  ("BODY" == w.doc[0].nodeName
                    ? w.css(t("html"), { "overflow-y": "hidden" })
                    : "HTML" == w.doc[0].nodeName && w.css(t("body"), { "overflow-y": "hidden" })),
                b.isios && !w.ispage && !w.haswrapper && w.css(t("body"), { "-webkit-overflow-scrolling": "touch" });
              ...
              var l,
                ...
                p = ["left", "right"];
              for (u in p)
                (c = p[u]), (l = w.opt.railpadding[c]) ? a.css("padding-" + c, l + "px") : (w.opt.railpadding[c] = 0);
              if (
                (a.append(r),
                (a.width =
                  Math.max(parseFloat(w.opt.cursorwidth), r.outerWidth()) +
                  w.opt.railpadding.left +
                  w.opt.railpadding.right),
                a.css({ width: a.width + "px", zIndex: w.zindex, background: w.opt.background, cursor: "default" }),
                (a.visibility = !0),
                (a.scrollable = !0),
                (a.align = "left" == w.opt.railalign ? 0 : 1),
                (w.rail = a),
                (r = w.rail.drag = !1),
                w.opt.boxzoom &&
                  !w.ispage &&
                  ...
                  b.cantouch &&
                    w.opt.gesturezoom &&
                    ((w.ongesturezoom = function (t) {
                      return 1.5 < t.scale && w.doZoomIn(t), 0.8 > t.scale && w.doZoomOut(t), w.cancelEvent(t);
                    }),
                    w.bind(w.win, "gestureend", w.ongesturezoom))),
                (w.railh = !1),
                w.opt.horizrailenabled)
              ) {
                w.css(n, { "overflow-x": "hidden" }),
                ...
                f.attr("id", w.id + "-hr"),
                  ...
                  (f.height = Math.max(parseFloat(w.opt.cursorwidth), r.outerHeight())),
                  f.css({ height: f.height + "px", zIndex: w.zindex, background: w.opt.background }),
                  f.append(r),
                  (f.visibility = !0),
                  (f.scrollable = !0),
                  (f.align = "top" == w.opt.railvalign ? 0 : 1),
                  (w.railh = f),
                  (w.railh.drag = !1);
              }
              if (
                (w.ispage
                  ? (a.css({ position: "fixed", top: "0px", height: "100%" }),
                    a.css(a.align ? { right: "0px" } : { left: "0px" }),
                    w.body.append(a),
                    w.railh &&
                      (f.css({ position: "fixed", left: "0px", width: "100%" }),
                      f.css(f.align ? { bottom: "0px" } : { top: "0px" }),
                      w.body.append(f)))
                  : (w.ishwscroll
                      ? ("static" == w.win.css("position") && w.css(w.win, { position: "relative" }),
                        (n = "HTML" == w.win[0].nodeName ? w.body : w.win),
                        w.zoom &&
                          (w.zoom.css({ position: "absolute", top: 1, right: 0, "margin-right": a.width + 4 }),
                          n.append(w.zoom)),
                        a.css({ position: "absolute", top: 0 }),
                        a.css(a.align ? { right: 0 } : { left: 0 }),
                        n.append(a),
                        f &&
                          (f.css({ position: "absolute", left: 0, bottom: 0 }),
                          f.css(f.align ? { bottom: 0 } : { top: 0 }),
                          n.append(f)))
                      : ((w.isfixed = "fixed" == w.win.css("position")),
                        (n = w.isfixed ? "fixed" : "absolute"),
                        w.isfixed || (w.viewport = w.getViewport(w.win[0])),
                        w.viewport &&
                          ((w.body = w.viewport),
                          0 == /fixed|relative|absolute/.test(w.viewport.css("position")) &&
                            w.css(w.viewport, { position: "relative" })),
                        a.css({ position: n }),
                        w.zoom && w.zoom.css({ position: n }),
                        w.updateScrollBar(),
                        w.body.append(a),
                        w.zoom && w.body.append(w.zoom),
                        w.railh && (f.css({ position: n }), w.body.append(f))),
                    b.isios &&
                      w.css(w.win, { "-webkit-tap-highlight-color": "rgba(0,0,0,0)", "-webkit-touch-callout": "none" }),
                    b.isie && w.opt.disableoutline && w.win.attr("hideFocus", "true"),
                    b.iswebkit && w.opt.disableoutline && w.win.css({ outline: "none" })),
                !1 === w.opt.autohidemode
                  ? ((w.autohidedom = !1),
                    w.rail.css({ opacity: w.opt.cursoropacitymax }),
                    w.railh && w.railh.css({ opacity: w.opt.cursoropacitymax }))
                  : !0 === w.opt.autohidemode || "leave" === w.opt.autohidemode
                  ? ((w.autohidedom = t().add(w.rail)),
                    b.isie8 && (w.autohidedom = w.autohidedom.add(w.cursor)),
                    w.railh && (w.autohidedom = w.autohidedom.add(w.railh)),
                    w.railh && b.isie8 && (w.autohidedom = w.autohidedom.add(w.cursorh)))
                  : "scroll" == w.opt.autohidemode
                  ? ((w.autohidedom = t().add(w.rail)), w.railh && (w.autohidedom = w.autohidedom.add(w.railh)))
                  : "cursor" == w.opt.autohidemode
                  ? ((w.autohidedom = t().add(w.cursor)), w.railh && (w.autohidedom = w.autohidedom.add(w.cursorh)))
                  : "hidden" == w.opt.autohidemode && ((w.autohidedom = !1), w.hide(), (w.locked = !1)),
                b.isie9mobile)
              )
                (w.scrollmom = new g(w)),
                  (w.onmangotouch = function (t) {
                    t = w.getScrollTop();
                    ...
                    if (0 != Math.round(Math.sqrt(Math.pow(o, 2) + Math.pow(i, 2)))) {
                      ...
                      w.mangotouch.lazy && clearTimeout(w.mangotouch.lazy),
                        80 < r - w.mangotouch.tm || w.mangotouch.dry != n || w.mangotouch.drx != s
                          ? (w.scrollmom.stop(),
                            w.scrollmom.reset(e, t),
                            (w.mangotouch.sy = t),
                            (w.mangotouch.ly = t),
                            (w.mangotouch.sx = e),
                            (w.mangotouch.lx = e),
                            ...
                            (w.mangotouch.tm = r))
                          : (w.scrollmom.stop(),
                            w.scrollmom.update(w.mangotouch.sx - o, w.mangotouch.sy - i),
                            (w.mangotouch.tm = r),
                            (i = Math.max(Math.abs(w.mangotouch.ly - t), Math.abs(w.mangotouch.lx - e))),
                            (w.mangotouch.ly = t),
                            (w.mangotouch.lx = e),
                            i > 2 &&
                              (w.mangotouch.lazy = setTimeout(function () {
                                (w.mangotouch.lazy = !1),
                                  (w.mangotouch.dry = 0),
                                  (w.mangotouch.drx = 0),
                                  (w.mangotouch.tm = 0),
                  ...
                  (a = w.getScrollTop()),
                  (f = w.getScrollLeft()),
                  (w.mangotouch = { sy: a, ly: a, dry: 0, sx: f, lx: f, drx: 0, lazy: !1, tm: 0 }),
                  ...
                  (w.scrollmom = new g(w)),
                    (w.ontouchstart = function (e) {
                      ...
                      if (((w.hasmoving = !1), !w.locked)) {
                        ...
                        if (
                          (w.cancelScroll(), (i = w.getTarget(e)) && /INPUT/i.test(i.nodeName) && /range/i.test(i.type))
                        )
                        ...
                        if (
                          ...
                          var o = t(window).width(),
                            ...
                            o = Math.max(0, s - o);
                          (w.rail.drag.ck =
                            !w.rail.scrollable && w.railh.scrollable
                              ? n > 0
                                ? "v"
                                : !1
                              : w.rail.scrollable && !w.railh.scrollable && o > 0
                              ? "h"
                              : !1),
                        ...
                        if (
                          (w.opt.touchbehavior &&
                            w.isiframe &&
                            b.isie &&
                            ((o = w.win.position()), (w.rail.drag.x += o.left), (w.rail.drag.y += o.top)),
                          (w.hasmoving = !1),
                          (w.lastmouseup = !1),
                          w.scrollmom.reset(e.clientX, e.clientY),
                          !b.cantouch && !this.istouchcapable && !b.hasmstouch)
                        ) {
                          if (!i || !/INPUT|SELECT|TEXTAREA/i.test(i.nodeName))
                            return (
                              !w.ispage && b.hasmousecapture && i.setCapture(),
                              w.opt.touchbehavior
                                ? (i.onclick &&
                                    !i._onclick &&
                          ...
                          /SUBMIT|CANCEL|BUTTON/i.test(t(i).attr("type")) &&
                            ((pc = { tg: i, click: !1 }), (w.preventclick = pc));
                        }
                      }
                    }),
                  ...
                  w.ontouchmove = function (e, i) {
                    ...
                    if (w.rail.drag && 2 == w.rail.drag.pt) {
                      ...
                      if (
                        ((w.hasmoving = !0),
                        w.preventclick &&
                          !w.preventclick.click &&
                          ((w.preventclick.click = w.preventclick.tg.onclick || !1),
                          (w.preventclick.tg.onclick = w.onpreventclick)),
                        (e = t.extend({ original: e }, e)),
                        "changedTouches" in e &&
                          ((e.clientX = e.changedTouches[0].clientX), (e.clientY = e.changedTouches[0].clientY)),
                        w.forcescreen)
                      ) {
                      ...
                      var s = e.clientY + ofy,
                        ...
                        l = w.rail.drag.st - n;
                      if (
                        (w.ishwscroll && w.opt.bouncescroll
                          ? 0 > l
                            ? (l = Math.round(l / 2))
                            : l > w.page.maxh && (l = w.page.maxh + Math.round((l - w.page.maxh) / 2))
                          : (0 > l && (s = l = 0), l > w.page.maxh && ((l = w.page.maxh), (s = 0))),
                        w.railh && w.railh.scrollable)
                      ) {
                        var c = w.rail.drag.sl - a;
                        w.ishwscroll && w.opt.bouncescroll
                          ? 0 > c
                            ? (c = Math.round(c / 2))
                            : c > w.page.maxw && (c = w.page.maxw + Math.round((c - w.page.maxw) / 2))
                          : (0 > c && (r = c = 0), c > w.page.maxw && ((c = w.page.maxw), (r = 0)));
                      }
                      if (((o = !1), w.rail.drag.dl))
                        ...
                        if ("v" == w.rail.drag.ck) {
                          if (n > d && 0.3 * n >= a) return (w.rail.drag = !1), !0;
                          a > d && ((w.rail.drag.dl = "f"), t("body").scrollTop(t("body").scrollTop()));
                        } else if ("h" == w.rail.drag.ck) {
                          if (a > d && 0.3 * a >= n) return (w.rail.drag = !1), !0;
                          n > d && ((w.rail.drag.dl = "f"), t("body").scrollLeft(t("body").scrollLeft()));
                        }
                      }
                      if (
                        (w.synched("touchmove", function () {
                          w.rail.drag &&
                            2 == w.rail.drag.pt &&
                            (w.prepareTransition && w.prepareTransition(0),
                            w.rail.scrollable && w.setScrollTop(l),
                            w.scrollmom.update(r, s),
                            w.railh && w.railh.scrollable ? (w.setScrollLeft(c), w.showCursor(l, c)) : w.showCursor(l),
                            b.isie10 && document.selection.clear());
                        }),
                        b.ischrome && w.istouchcapable && (o = !1),
                        o)
                      )
                ...
                if (
                  ((w.onmousedown = function (t, e) {
                    if (!w.rail.drag || 1 == w.rail.drag.pt) {
                      ...
                      w.cancelScroll(),
                        (w.rail.drag = { x: t.clientX, y: t.clientY, sx: w.scroll.x, sy: w.scroll.y, pt: 1, hr: !!e });
                      var i = w.getTarget(t);
                      return (
                        !w.ispage && b.hasmousecapture && i.setCapture(),
                        w.isiframe &&
                          !b.hasmousecapture &&
                          ((w.saved.csspointerevents = w.doc.css("pointer-events")),
                          w.css(w.doc, { "pointer-events": "none" })),
                        (w.hasmoving = !1),
                        w.cancelEvent(t)
                      );
                    }
                  ...
                  (w.onmouseup = function (t) {
                    return w.rail.drag &&
                      (b.hasmousecapture && document.releaseCapture(),
                      w.isiframe && !b.hasmousecapture && w.doc.css("pointer-events", w.saved.csspointerevents),
                      1 == w.rail.drag.pt)
                      ? ((w.rail.drag = !1), w.hasmoving && w.triggerScrollEnd(), w.cancelEvent(t))
                      : void 0;
                  }),
                  (w.onmousemove = function (t) {
                    if (w.rail.drag && 1 == w.rail.drag.pt) {
                      ...
                      if (((w.cursorfreezed = !0), (w.hasmoving = !0), w.rail.drag.hr)) {
                        ...
                        (w.scroll.y = w.rail.drag.sy + (t.clientY - w.rail.drag.y)),
                          0 > w.scroll.y && (w.scroll.y = 0),
                          (e = w.scrollvaluemax),
                          w.scroll.y > e && (w.scroll.y = e);
                      return (
                        w.synched("mousemove", function () {
                          w.rail.drag &&
                            1 == w.rail.drag.pt &&
                            (w.showCursor(),
                            w.rail.drag.hr
                              ? w.doScrollLeft(Math.round(w.scroll.x * w.scrollratio.x), w.opt.cursordragspeed)
                              : w.doScrollTop(Math.round(w.scroll.y * w.scrollratio.y), w.opt.cursordragspeed));
                        }),
                        w.cancelEvent(t)
                      );
                    }
                  ...
                  (w.onpreventclick = function (t) {
                    return w.preventclick
                      ? ((w.preventclick.tg.onclick = w.preventclick.click), (w.preventclick = !1), w.cancelEvent(t))
                      : void 0;
                  }),
                    ...
                    w.opt.grabcursorenabled &&
                      b.cursorgrabvalue &&
                      (w.css(w.ispage ? w.doc : w.win, { cursor: b.cursorgrabvalue }),
                      w.css(w.rail, { cursor: b.cursorgrabvalue }));
                else {
                  var v = function (t) {
                    if (w.selectiondrag) {
                      if (t) {
                        var e = w.win.outerHeight();
                        (t = t.pageY - w.selectiondrag.top),
                          t > 0 && e > t && (t = 0),
                          t >= e && (t -= e),
                          (w.selectiondrag.df = t);
                      }
                      0 != w.selectiondrag.df &&
                        (w.doScrollBy(2 * -Math.floor(w.selectiondrag.df / 6)),
                        w.debounced(
                          "doselectionscroll",
                          function () {
                            v();
                ...
                b.hasmstouch &&
                  (w.css(w.rail, { "-ms-touch-action": "none" }),
                  w.css(w.cursor, { "-ms-touch-action": "none" }),
                  ...
                  w.bind(w.cursor, "MSGestureHold", function (t) {
                    t.preventDefault();
                  }),
                  ...
                  this.istouchcapable &&
                    (w.bind(w.win, "touchstart", w.ontouchstart),
                  ...
                  w.railh &&
                    (w.bind(w.cursorh, "mousedown", function (t) {
                      w.onmousedown(t, !0);
                    }),
                    w.bind(w.cursorh, "mouseup", w.onmouseup)),
                  (w.opt.cursordragontouch || (!b.cantouch && !w.opt.touchbehavior)) &&
                    (w.rail.css({ cursor: "default" }),
                    w.railh && w.railh.css({ cursor: "default" }),
                    w.jqbind(w.rail, "mouseenter", function () {
                      return w.win.is(":visible")
                        ? (w.canshowonmouseevent && w.showCursor(), void (w.rail.active = !0))
                        : !1;
                    }),
                    ...
                    w.opt.sensitiverail &&
                      (w.bind(w.rail, "click", function (t) {
                        w.doRailClick(t, !1, !1);
                      }),
                    ...
                    w.railh &&
                      (w.jqbind(w.railh, "mouseenter", function () {
                        return w.win.is(":visible")
                          ? (w.canshowonmouseevent && w.showCursor(), void (w.rail.active = !0))
                          : !1;
                      }),
                      ...
                      w.opt.sensitiverail &&
                        (w.bind(w.railh, "click", function (t) {
                          w.doRailClick(t, !1, !0);
                        }),
                  ...
                  b.cantouch || w.opt.touchbehavior
                    ? (w.bind(b.hasmousecapture ? w.win : document, "mouseup", w.ontouchend),
                      w.bind(document, "mousemove", w.ontouchmove),
                      w.onclick && w.bind(document, "click", w.onclick),
                      w.opt.cursordragontouch &&
                        (w.bind(w.cursor, "mousedown", w.onmousedown),
                        w.bind(w.cursor, "mousemove", w.onmousemove),
                        w.cursorh &&
                          w.bind(w.cursorh, "mousedown", function (t) {
                            w.onmousedown(t, !0);
                          }),
                        w.cursorh && w.bind(w.cursorh, "mousemove", w.onmousemove)))
                    : (w.bind(b.hasmousecapture ? w.win : document, "mouseup", w.onmouseup),
                      w.bind(document, "mousemove", w.onmousemove),
                      w.onclick && w.bind(document, "click", w.onclick),
                      !w.ispage &&
                        w.opt.enablescrollonselection &&
                        (w.bind(w.win[0], "mousedown", w.onselectionstart),
                      ...
                      w.zoom &&
                        (w.jqbind(w.zoom, "mouseenter", function () {
                          w.canshowonmouseevent && w.showCursor(), (w.rail.active = !0);
                        }),
                        w.jqbind(w.zoom, "mouseleave", function () {
                          (w.rail.active = !1), w.rail.drag || w.hideCursor();
                        }))),
                  w.opt.enablemousewheel &&
                    (w.isiframe || w.bind(b.isie && w.ispage ? document : w.win, "mousewheel", w.onmousewheel),
                    w.bind(w.rail, "mousewheel", w.onmousewheel),
                    w.railh && w.bind(w.railh, "mousewheel", w.onmousewheelhr)),
                  !w.ispage &&
                    !b.cantouch &&
                    !/HTML|^BODY/.test(w.win[0].nodeName) &&
                    (w.win.attr("tabindex") || w.win.attr({ tabindex: o++ }),
              ...
              if (
                ((w.onkeypress = function (o) {
                  if (w.locked && 0 == w.page.maxh) return !0;
                  o = o ? o : window.e;
                  var n = w.getTarget(o);
                  if (
                    (n &&
                      /INPUT|TEXTAREA|SELECT|OPTION/.test(n.nodeName) &&
                      ((!n.getAttribute("type") && !n.type) || !/submit|button|cancel/i.tp)) ||
                    t(n).attr("contenteditable")
                  )
                    return !0;
                ...
                w.opt.enablekeyboard &&
                  w.bind(document, b.isopera && !b.isopera12 ? "keypress" : "keydown", w.onkeypress),
                w.bind(document, "keydown", function (t) {
                ...
                b.ischrome && !w.ispage && !w.haswrapper)
              ) {
              ...
              (w.onAttributeChange = function () {
                ...
                !w.ispage &&
                  !w.haswrapper &&
                  (!1 !== h
                    ? ((w.observer = new h(function (t) {
                        t.forEach(w.onAttributeChange);
                      })),
                      w.observer.observe(w.win[0], { childList: !0, characterData: !1, attributes: !0, subtree: !1 }),
                      (w.observerremover = new h(function (t) {
                        t.forEach(function (t) {
                          if (0 < t.removedNodes.length)
                            for (var e in t.removedNodes) if (t.removedNodes[e] == w.win[0]) return w.remove();
                        });
                      })),
                    ...
                    : (w.bind(w.win, b.isie && !b.isie9 ? "propertychange" : "DOMAttrModified", w.onAttributeChange),
                      b.isie9 && w.win[0].attachEvent("onpropertychange", w.onAttributeChange),
                      w.bind(w.win, "DOMNodeRemoved", function (t) {
                        t.target == w.win[0] && w.remove();
                      }))),
                !w.ispage && w.opt.boxzoom && w.bind(window, "resize", w.resizeZoom),
                w.istextarea && w.bind(w.win, "mouseup", w.lazyResize),
                w.lazyResize(30);
            }
            if ("IFRAME" == this.doc[0].nodeName) {
              var x = function (e) {
                ...
                return w.iframexd
                  ? ("console" in window && console.log("NiceScroll error: policy restriced iframe"), !0)
                  : ((w.forcescreen = !0),
                    w.isiframe &&
                      ((w.iframe = {
                        doc: t(i),
                      ...
                      (w.docscroll = t(w.iframe.body))),
                    !b.isios &&
                      w.opt.iframeautoresize &&
                      !w.isiframe &&
                      (w.win.scrollTop(0),
                      w.doc.height(""),
                      ...
                      w.doc.height(e)),
                    w.lazyResize(30),
                    b.isie7 && w.css(t(w.iframe.html), { "overflow-y": "hidden" }),
                    w.css(t(w.iframe.body), { "overflow-y": "hidden" }),
                    b.isios && w.haswrapper && w.css(t(i.body), { "-webkit-transform": "translate3d(0,0,0)" }),
                    "contentWindow" in this
                      ? w.bind(this.contentWindow, "scroll", w.onscroll)
                      : w.bind(i, "scroll", w.onscroll),
                    w.opt.enablemousewheel && w.bind(i, "mousewheel", w.onmousewheel),
                    w.opt.enablekeyboard && w.bind(i, b.isopera ? "keypress" : "keydown", w.onkeypress),
                    (b.cantouch || w.opt.touchbehavior) &&
                      (w.bind(i, "mousedown", w.ontouchstart),
                      w.bind(i, "mousemove", function (t) {
                        w.ontouchmove(t, !0);
                      }),
                      w.opt.grabcursorenabled && b.cursorgrabvalue && w.css(t(i.body), { cursor: b.cursorgrabvalue })),
                    w.bind(i, "mouseup", w.ontouchend),
                    void (
                      w.zoom &&
                      (w.opt.dblclickzoom && w.bind(i, "dblclick", w.doZoom),
                      w.ongesturezoom && w.bind(i, "gestureend", w.ongesturezoom))
                    ));
              };
          ...
          (this.showCursor = function (t, e) {
            w.cursortimeout && (clearTimeout(w.cursortimeout), (w.cursortimeout = 0)),
              w.rail &&
                (w.autohidedom &&
                  (w.autohidedom.stop().css({ opacity: w.opt.cursoropacitymax }), (w.cursoractive = !0)),
                (w.rail.drag && 1 == w.rail.drag.pt) ||
                  ("undefined" != typeof t && !1 !== t && (w.scroll.y = Math.round((1 * t) / w.scrollratio.y)),
                  "undefined" != typeof e && (w.scroll.x = Math.round((1 * e) / w.scrollratio.x))),
                w.cursor.css({ height: w.cursorheight, top: w.scroll.y }),
                w.cursorh &&
                  (w.cursorh.css(
                    !w.rail.align && w.rail.visibility
                      ? { width: w.cursorwidth, left: w.scroll.x + w.rail.width }
                      : { width: w.cursorwidth, left: w.scroll.x }
                  ),
                  (w.cursoractive = !0)),
                w.zoom && w.zoom.stop().css({ opacity: w.opt.cursoropacitymax }));
          }),
          (this.hideCursor = function (t) {
            !w.cursortimeout &&
              w.rail &&
              w.autohidedom &&
              !(w.hasmousefocus && "leave" == w.opt.autohidemode) &&
              (w.cursortimeout = setTimeout(function () {
                (w.rail.active && w.showonmouseevent) ||
                  (w.autohidedom.stop().animate({ opacity: w.opt.cursoropacitymin }),
                  w.zoom && w.zoom.stop().animate({ opacity: w.opt.cursoropacitymin }),
                  (w.cursoractive = !1)),
                  (w.cursortimeout = 0);
            ...
            return (
              ...
              0 == w.page.maxw
                ? (w.hideRailHr(),
                  ...
                  (w.cursorwidth = 0),
                  w.setScrollLeft(0),
                  (w.railh.scrollable = !1))
                : (w.railh.scrollable = !0),
              (w.locked = 0 == w.page.maxh && 0 == w.page.maxw),
              w.locked
                ? (w.ispage || w.updateScrollBar(w.view), !1)
                : (w.hidden || w.visibility
                    ? !w.hidden && !w.railh.visibility && w.showRailHr()
                    : w.showRail().showRailHr(),
                  w.istextarea && w.win.css("resize") && "none" != w.win.css("resize") && (w.view.h -= 20),
                  (w.cursorheight = Math.min(w.view.h, Math.round(w.view.h * (w.view.h / w.page.h)))),
                  (w.cursorheight = w.opt.cursorfixedheight
                    ? w.opt.cursorfixedheight
                    : Math.max(w.opt.cursorminheight, w.cursorheight)),
                  (w.cursorwidth = Math.min(w.view.w, Math.round(w.view.w * (w.view.w / w.page.w)))),
                  (w.cursorwidth = w.opt.cursorfixedheight
                    ? w.opt.cursorfixedheight
                    : Math.max(w.opt.cursorminheight, w.cursorwidth)),
                  (w.scrollvaluemax = w.view.h - w.cursorheight - w.cursor.hborder),
                  w.railh &&
                    ((w.railh.width = 0 < w.page.maxh ? w.view.w - w.rail.width : w.view.w),
                    (w.scrollvaluemaxw = w.railh.width - w.cursorwidth - w.cursorh.wborder)),
                  w.ispage || w.updateScrollBar(w.view),
                  (w.scrollratio = { x: w.page.maxw / w.scrollvaluemaxw, y: w.page.maxh / w.scrollvaluemax }),
                  w.getScrollTop() > w.page.maxh
                    ? w.doScrollTop(w.page.maxh)
          ...
          (this._bind = function (t, e, i, o) {
            w.events.push({ e: t, n: e, f: i, b: o, q: !1 }),
              t.addEventListener
          ...
          (this.jqbind = function (e, i, o) {
            w.events.push({ e: e, n: i, f: o, q: !0 }), t(e).bind(i, o);
          }),
          (this.bind = function (t, e, i, o) {
            var n = "jquery" in t ? t[0] : t;
            "mousewheel" == e
              ? "onwheel" in w.win
                ? w._bind(n, "wheel", i, o || !1)
                : ((t = "undefined" != typeof document.onmousewheel ? "mousewheel" : "DOMMouseScroll"),
                  m(n, t, i, o || !1),
                  "DOMMouseScroll" == t && m(n, "MozMousePixelScroll", i, o || !1))
              : n.addEventListener
              ? (b.cantouch &&
                  /mouseup|mousedown|mousemove/.test(e) &&
                  w._bind(
                    n,
                    "mousedown" == e ? "touchstart" : "mouseup" == e ? "touchend" : "touchmove",
                    function (t) {
                      if (t.touches) {
                ...
                w._bind(n, e, i, o || !1),
                b.cantouch && "mouseup" == e && w._bind(n, "touchcancel", i, o || !1))
              : w._bind(n, e, function (t) {
                  return (
                    (t = t || window.event || !1) && t.srcElement && (t.target = t.srcElement),
                    "pageY" in t ||
                      ((t.pageX = t.clientX + document.documentElement.scrollLeft),
                      (t.pageY = t.clientY + document.documentElement.scrollTop)),
                    !1 === i.call(n, t) || !1 === o ? w.cancelEvent(t) : !0
                  );
                });
          }),
          ...
          (this.cancelEvent = function (t) {
            return (t = t.original ? t.original : t ? t : window.event || !1)
          ...
          (this.stopPropagation = function (t) {
            return (t = t.original ? t.original : t ? t : window.event || !1)
              ? t.stopPropagation
                ? t.stopPropagation()
                : (t.cancelBubble && (t.cancelBubble = !0), !1)
              : !1;
          }),
          (this.showRail = function () {
            return (
              0 == w.page.maxh ||
                (!w.ispage && "none" == w.win.css("display")) ||
                ((w.visibility = !0), (w.rail.visibility = !0), w.rail.css("display", "block")),
              w
            );
          }),
          (this.showRailHr = function () {
            return w.railh
              ? (0 == w.page.maxw ||
                  (!w.ispage && "none" == w.win.css("display")) ||
                  ((w.railh.visibility = !0), w.railh.css("display", "block")),
                w)
              : w;
          }),
          ...
          (this.remove = function () {
            w.stop(),
              ...
              w.doZoomOut(),
              w.unbindAll(),
              b.isie9 && w.win[0].detachEvent("onpropertychange", w.onAttributeChange),
          ...
          (this.triggerScrollEnd = function () {
            if (w.onscrollend) {
              var t = w.getScrollLeft(),
                e = w.getScrollTop();
              w.onscrollend.call(w, { type: "scrollend", current: { x: t, y: e }, end: { x: t, y: e } });
            }
          }),
          (this.onmousewheel = function (t) {
            if (!w.wheelprevented) {
              ...
              if (
                ("auto" == w.opt.oneaxismousemode && 0 != t.deltaX && (w.opt.oneaxismousemode = !1),
                w.opt.oneaxismousemode && 0 == t.deltaX && !w.rail.scrollable)
              )
                return w.railh && w.railh.scrollable ? w.onmousewheelhr(t) : !0;
              var e = +new Date(),
                i = !1;
              return (
                w.opt.preservenativescrolling &&
                  w.checkarea + 600 < e &&
                  ((w.nativescrollingarea = w.isScrollable(t)), (i = !0)),
                (w.checkarea = e),
                w.nativescrollingarea ? !0 : ((t = v(t, !1, i)) && (w.checkarea = 0), t)
              );
            }
          }),
            ...
            if (!w.wheelprevented) {
              ...
              return (
                w.opt.preservenativescrolling &&
                  ...
                  ((w.nativescrollingarea = w.isScrollable(t)), (i = !0)),
                (w.checkarea = e),
                w.nativescrollingarea ? !0 : w.locked ? w.cancelEvent(t) : v(t, !0, i)
              );
            }
          }),
          (this.stop = function () {
          ...
          w.opt.smoothscroll
            ? w.ishwscroll && b.hastransition && w.opt.usetransition
              ? ((this.prepareTransition = function (t, e) {
                  var i = e ? (t > 20 ? t : 0) : w.getTransitionSpeed(t),
                    o = i ? b.prefixstyle + "transform " + i + "ms ease-out" : "";
                  return (
                    (w.lasttransitionstyle && w.lasttransitionstyle == o) ||
                      ((w.lasttransitionstyle = o), w.doc.css(b.transitionstyle, o)),
                    i
                  );
                }),
                ...
                (this.doScrollPos = function (t, e, i) {
                  var o = w.getScrollTop(),
                    n = w.getScrollLeft();
                  return (
                    (0 > (w.newscrolly - o) * (e - o) || 0 > (w.newscrollx - n) * (t - n)) && w.cancelScroll(),
                    0 == w.opt.bouncescroll &&
                      (0 > e ? (e = 0) : e > w.page.maxh && (e = w.page.maxh),
                      0 > t ? (t = 0) : t > w.page.maxw && (t = w.page.maxw)),
                    w.scrollrunning && t == w.newscrollx && e == w.newscrolly
                      ? !1
                      : ((w.newscrolly = e),
                        (w.newscrollx = t),
                        ...
                        w.timer
                          ...
                          : void (w.timer = setTimeout(function () {
                              ...
                              (i = t - s),
                                ...
                                (i =
                                  w.newscrollspeed && 1 < w.newscrollspeed
                                    ? w.newscrollspeed
                                    : w.getTransitionSpeed(i)),
                                w.newscrollspeed && 1 >= w.newscrollspeed && (i *= w.newscrollspeed),
                                w.prepareTransition(i, !0),
                                w.timerscroll && w.timerscroll.tm && clearInterval(w.timerscroll.tm),
                                i > 0 &&
                                  (!w.scrollrunning &&
                                    w.onscrollstart &&
                                    w.onscrollstart.call(w, {
                                      type: "scrollstart",
                                      current: { x: s, y: n },
                                      request: { x: t, y: e },
                                  ...
                                  b.transitionend
                                    ? w.scrollendtrapped ||
                                      ((w.scrollendtrapped = !0),
                                      w.bind(w.doc, b.transitionend, w.onScrollTransitionEnd, !1))
                                    : (w.scrollendtrapped && clearTimeout(w.scrollendtrapped),
                                      (w.scrollendtrapped = setTimeout(w.onScrollTransitionEnd, i))),
                                  (w.timerscroll = {
                                    bz: new BezierClass(n, w.newscrolly, i, 0, 0, 0.58, 1),
                                    bh: new BezierClass(s, w.newscrollx, i, 0, 0, 0.58, 1),
                                  }),
                                  w.cursorfreezed ||
                                    (w.timerscroll.tm = setInterval(function () {
                ...
                (this.cancelScroll = function () {
                  ...
                  return (
                    ...
                    w._unbind(w.doc, b.transitionend, w.onScrollTransitionEnd),
                    w.prepareTransition(0),
                    w.setScrollTop(t),
                    w.railh && w.setScrollLeft(e),
                    w.timerscroll && w.timerscroll.tm && clearInterval(w.timerscroll.tm),
                    (w.timerscroll = !1),
                    (w.cursorfreezed = !1),
                    w.showCursor(t, e),
                ...
                (this.onScrollTransitionEnd = function () {
                  w.scrollendtrapped && w._unbind(w.doc, b.transitionend, w.onScrollTransitionEnd),
                    (w.scrollendtrapped = !1),
                    w.prepareTransition(0),
                    w.timerscroll && w.timerscroll.tm && clearInterval(w.timerscroll.tm),
                    (w.timerscroll = !1);
                  ...
                  return (
                    w.setScrollTop(t),
                    w.railh && w.setScrollLeft(e),
                    w.noticeCursor(!1, t, e),
                    (w.cursorfreezed = !1),
                    0 > t ? (t = 0) : t > w.page.maxh && (t = w.page.maxh),
                    0 > e ? (e = 0) : e > w.page.maxw && (e = w.page.maxw),
                    t != w.newscrolly || e != w.newscrollx
                      ? w.doScrollPos(e, t, w.opt.snapbackspeed)
                      : (w.onscrollend && w.scrollrunning && w.triggerScrollEnd(), void (w.scrollrunning = !1))
                  );
                }))
              : ((this.doScrollLeft = function (t, e) {
                  var i = w.scrollrunning ? w.newscrolly : w.getScrollTop();
                ...
                (this.doScrollPos = function (t, e, i) {
                  function o() {
                    ...
                    if (w.dst.ay) {
                      var e = w.bzscroll ? w.dst.py + w.bzscroll.getNow() * w.dst.ay : w.newscrolly,
                        i = e - sy;
                      ((0 > i && e < w.newscrolly) || (i > 0 && e > w.newscrolly)) && (e = w.newscrolly),
                        w.setScrollTop(e),
                        e == w.newscrolly && (t = 1);
                    } else t = 1;
                    var n = (sx = w.getScrollLeft());
                    w.dst.ax
                      ? ((n = w.bzscroll ? w.dst.px + w.bzscroll.getNow() * w.dst.ax : w.newscrollx),
                        (i = n - sx),
                        ((0 > i && n < w.newscrollx) || (i > 0 && n > w.newscrollx)) && (n = w.newscrollx),
                        w.setScrollLeft(n),
                        n == w.newscrollx && (t += 1))
                      : (t += 1),
                      2 == t
                        ? ((w.timer = 0),
                          ...
                          (w.scrollrunning = !1),
                          0 > e ? (e = 0) : e > w.page.maxh && (e = w.page.maxh),
                          0 > n ? (n = 0) : n > w.page.maxw && (n = w.page.maxw),
                          n != w.newscrollx || e != w.newscrolly
                            ? w.doScrollPos(n, e)
                            : w.onscrollend && w.triggerScrollEnd())
                        : (w.timer = a(o) || 1);
                  }
                  if (
                    ((e = "undefined" == typeof e || !1 === e ? w.getScrollTop(!0) : e),
                    w.timer && w.newscrolly == e && w.newscrollx == t)
                  )
                    return !0;
                  w.timer && l(w.timer), (w.timer = 0);
                  var n = w.getScrollTop(),
                    s = w.getScrollLeft();
                  (0 > (w.newscrolly - n) * (e - n) || 0 > (w.newscrollx - s) * (t - s)) && w.cancelScroll(),
                    (w.newscrolly = e),
                    (w.newscrollx = t),
                    (w.bouncescroll && w.rail.visibility) ||
                      (0 > w.newscrolly
                        ? (w.newscrolly = 0)
                        : w.newscrolly > w.page.maxh && (w.newscrolly = w.page.maxh)),
                    (w.bouncescroll && w.railh.visibility) ||
                      (0 > w.newscrollx
                        ? (w.newscrollx = 0)
                        : w.newscrollx > w.page.maxw && (w.newscrollx = w.page.maxw)),
                    (w.dst = {}),
                    (w.dst.x = t - s),
                    (w.dst.y = e - n),
                    (w.dst.px = s),
                  ...
                  if (
                    (0 == w.dst.x
                      ? ((c = n), (d = e), (w.dst.ay = 1), (w.dst.py = 0))
                      : 0 == w.dst.y && ((c = s), (d = t), (w.dst.ax = 1), (w.dst.px = 0)),
                    (r = w.getTransitionSpeed(r)),
                    i && 1 >= i && (r *= i),
                    (w.bzscroll =
                      r > 0 ? (w.bzscroll ? w.bzscroll.update(d, r) : new BezierClass(c, d, r, 0, 1, 0, 1)) : !1),
                    !w.timer)
                  ) {
                    ((n == w.page.maxh && e >= w.page.maxh) || (s == w.page.maxw && t >= w.page.maxw)) &&
                      w.checkContentSize();
                    var h = 1;
                    (w.cancelAnimationFrame = !1),
                      ...
                      o(),
                      ((n == w.page.maxh && e >= n) || (s == w.page.maxw && t >= s)) && w.checkContentSize(),
                      w.noticeCursor();
                  }
                }),
                (this.cancelScroll = function () {
          ...
          (this.doScrollBy = function (t, e) {
            var i = 0,
              i = e
                ? Math.floor((w.scroll.y - t) * w.scrollratio.y)
                : (w.timer ? w.newscrolly : w.getScrollTop(!0)) - t;
            if (w.bouncescroll) {
            ...
            return (
              ...
              0 > i && 0 >= py
                ? w.noticeCursor()
                : i > w.page.maxh && py >= w.page.maxh
                ? (w.checkContentSize(), w.noticeCursor())
          ...
          (this.doScrollLeftBy = function (t, e) {
            var i = 0,
              i = e
                ? Math.floor((w.scroll.x - t) * w.scrollratio.x)
                : (w.timer ? w.newscrollx : w.getScrollLeft(!0)) - t;
            if (w.bouncescroll) {
            ...
            return (
              (w.cursorfreezed = !1),
              (px = w.getScrollLeft(!0)),
              (0 > i && 0 >= px) || (i > w.page.maxw && px >= w.page.maxw) ? w.noticeCursor() : void w.doScrollLeft(i)
            );
          }),
          ...
          (this.doZoomIn = function (e) {
            if (!w.zoomactive) {
              ...
              return (
                (w.zoomrestore.style.width = w.win.css("width")),
                ...
                b.isios4 && ((w.zoomrestore.scrollTop = t(window).scrollTop()), t(window).scrollTop(0)),
                w.win.css({
                ...
                (o = w.win.css("backgroundColor")),
                ("" == o || /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(o)) &&
                  w.win.css("backgroundColor", "#fff"),
                w.rail.css({ "z-index": s + 101 }),
                w.zoom.css({ "z-index": s + 102 }),
          ...
          (this.doZoomOut = function (e) {
            return w.zoomactive
              ? ((w.zoomactive = !1),
                ...
                b.isios4 && t(window).scrollTop(w.zoomrestore.scrollTop),
                w.rail.css({ "z-index": w.zindex }),
                w.zoom.css({ "z-index": w.zindex }),
                (w.zoomrestore = !1),
          ...
          (this.resizeZoom = function () {
            if (w.zoomactive) {
              ...
              w.win.css({
                ...
                w.onResize(),
                w.setScrollTop(Math.min(w.page.maxh, e));
            }
          }),
          this.init(),
        ...
        (this.nc = t),
          ...
          (this.update = function (t, i) {
            ...
            var o = i - e.lasty,
              ...
              s = s + o,
              r = r + n;
            (e.snapx = 0 > r || r > e.nc.page.maxw),
              (e.snapy = 0 > s || s > e.nc.page.maxh),
              (e.speedx = n),
              (e.speedy = o),
              (e.lastx = t),
              (e.lasty = i);
          ...
          (this.doSnapy = function (t, i) {
            var o = !1;
            0 > i ? ((i = 0), (o = !0)) : i > e.nc.page.maxh && ((i = e.nc.page.maxh), (o = !0)),
              0 > t ? ((t = 0), (o = !0)) : t > e.nc.page.maxw && ((t = e.nc.page.maxw), (o = !0)),
              o ? e.nc.doScrollPos(t, i, e.nc.opt.snapbackspeed) : e.nc.triggerScrollEnd();
          }),
          (this.doMomentum = function (t) {
            ...
            var n = e.nc.getScrollTop(),
              ...
              r = e.nc.page.maxw;
            if (
              ((e.speedx = r > 0 ? Math.min(60, e.speedx) : 0),
              (e.speedy = s > 0 ? Math.min(60, e.speedy) : 0),
              (o = o && 60 >= i - o),
              (0 > n || n > s || 0 > t || t > r) && (o = !1),
              (t = e.speedx && o ? e.speedx : !1),
              (e.speedy && o && e.speedy) || t)
            ) {
              var a = Math.max(16, e.steptime);
              a > 50 && ((t = a / 50), (e.speedx *= t), (e.speedy *= t), (a = 50)),
                (e.demulxy = 0),
              ...
              var l = e.lastscrollx,
                c = e.lastscrolly,
                d = function () {
                  var t = 600 < e.time() - i ? 0.04 : 0.02;
                  e.speedx &&
                    ((l = Math.floor(e.lastscrollx - e.speedx * (1 - e.demulxy))),
                    (e.lastscrollx = l),
                    0 > l || l > r) &&
                    (t = 0.1),
                    e.speedy &&
                      ((c = Math.floor(e.lastscrolly - e.speedy * (1 - e.demulxy))),
                      (e.lastscrolly = c),
                      0 > c || c > s) &&
                      (t = 0.1),
                    (e.demulxy = Math.min(1, e.demulxy + t)),
                    e.nc.synched("domomentum2d", function () {
                      e.speedx && (e.nc.getScrollLeft() != e.chkx && e.stop(), (e.chkx = l), e.nc.setScrollLeft(l)),
                        e.speedy && (e.nc.getScrollTop() != e.chky && e.stop(), (e.chky = c), e.nc.setScrollTop(c)),
                        e.timer || (e.nc.hideCursor(), e.doSnapy(l, c));
                    }),
    ...
    (o.prototype = {
      ...
      getPositions: function () {
        ...
        n.$nav.each(function () {
          (e = n.getHash(t(this))),
            (o = t("#" + e)),
            o.length && ((i = o.offset().top), (n.sections[e] = Math.round(i)));
        });
      },
      ...
      handleClick: function (i) {
        var o = this,
          ...
          s = n.parent(),
          r = "#" + o.getHash(n);
        s.hasClass(o.config.currentClass) ||
          (o.config.begin && o.config.begin(),
          o.adjustNav(o, s),
          o.unbindInterval(),
          o.scrollTo(r, function () {
      ...
      scrollChange: function () {
        ...
        null !== i &&
          ...
          t.hasClass(this.config.currentClass) ||
            (this.adjustNav(this, t), this.config.scrollChange && this.config.scrollChange(t)));
      },
  ...
  (function () {
    ...
    $(window).scroll(function () {
      let height = $("#main-slider").height();
      height < $(window).scrollTop() && !e && (t.addClass("bg-change animated"), (e = !0)),
        height > $(window).scrollTop() && e && (t.removeClass("bg-change animated"), (e = !1));
    });
  })(),
  ...
  jQuery(document).ready(function () {
    ...
    $(".counter").counterUp({ delay: 10, time: 3e3 }),
      $(".image-popup-vertical-fit").magnificPopup({ type: "image", gallery: { enabled: !0 } });
    var e = new WOW({ boxClass: "wow", animateClass: "animated", offset: 0, mobile: !1 });
    e.init(),
      11 != t() &&
        $("html").niceScroll({
          cursorcolor: "#e74c3c",
    ...
    var i = $("#project-items"),
      o = function () {
        var t = i.width(),
          ...
          o = 0;
        return (
          t > 960 ? (e = 4) : t > 640 ? (e = 2) : t > 480 ? (e = 2) : t > 360 && (e = 1),
          (o = Math.floor(t / e)),
          i.find(".item").each(function () {
            var t = $(this),
              ...
              n = e ? o * e[1] : o,
              s = i ? o * i[1] * 0.7 - 10 : 0.7 * o - 10;
            t.css({ width: n, height: s });
          }),
          o
        );
      },
      n = function () {
        i.isotope({ resizable: !0, itemSelector: ".item", masonry: { columnWidth: o(), gutterWidth: 10 } });
      };
    n(),
      $(window).smartresize(n),
      $(".itemFilter a").click(function () {
        $(".itemFilter .current").removeClass("current"), $(this).addClass("current");
        var t = $(this).attr("data-filter");
        return i.isotope({ filter: t, animationOptions: { duration: 750, easing: "linear", queue: !1 } }), !1;
      });
  }),
